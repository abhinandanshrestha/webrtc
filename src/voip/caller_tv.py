...
from call_handler_tv import CallHandler, convert_8bit_to_16bit, get_audio_bytes
import threading
# import argparse
...
try:
    ...
    # call = phone.call('9822538198')
    call = phone.call('9846966691')
    ...
    while call.state == CallState.ANSWERED:
        ...
        if audio_bytes:
            ...
            if not start_thread:
                time.sleep(1)
                call.write_audio(get_audio_bytes('/home/oem/webrtc/src/callbot/audios/isp1 (2).wav'))
