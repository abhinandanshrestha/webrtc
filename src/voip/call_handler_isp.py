    ...
    def tts(self):
        ...
        while True:
            ...
            if self.tts_queue and not self.tts_queue.empty():
                ...
                if self.state==1:
                    if llm_output=='yes':
                        audio_array=get_audio_bytes('/home/oem/webrtc/src/callbot/audios/isp2_yes.wav')
                        ...
                        audio_array=get_audio_bytes('/home/oem/webrtc/src/callbot/audios/isp2_no.wav')
                        ...
                        audio_array=get_audio_bytes('/home/oem/webrtc/src/callbot/audios/isp1.wav')
                    ...
                    if llm_output=='yes':
                        audio_array=get_audio_bytes('/home/oem/webrtc/src/callbot/audios/isp3_yes.wav')
                        ...
                        audio_array=get_audio_bytes('/home/oem/webrtc/src/callbot/audios/isp3_no.wav')
                    ...
                    if llm_output=='yes':
                        audio_array=get_audio_bytes('/home/oem/webrtc/src/callbot/audios/isp4_yes.wav')
                        ...
                        audio_array=get_audio_bytes('/home/oem/webrtc/src/callbot/audios/isp4_no.wav')
                    ...
                    if llm_output=='yes':
                        audio_array=get_audio_bytes('/home/oem/webrtc/src/callbot/audios/isp5.wav')
